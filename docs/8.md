...
<a target="__blank" href="https://leetcode.com/problems/string-to-integer-atoi/"><input class="verify-button" type="button" value="Verify on LeetCode"/></a>

```python
{% 
    include "../python/_8.py" 
    preserve-includer-indent=false 
%}
```
