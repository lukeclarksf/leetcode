...
<a target="__blank" href="https://leetcode.com/problems/reverse-integer/"><input class="verify-button" type="button" value="Verify on LeetCode"/></a>

```python
{% 
    include "../python/_7.py" 
    preserve-includer-indent=false 
%}
```
