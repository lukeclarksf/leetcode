...
<a target="__blank" href="https://leetcode.com/problems/median-of-two-sorted-arrays/"><input class="verify-button" type="button" value="Verify on LeetCode"/></a>

```python
{% 
    include "../python/_4.py" 
    preserve-includer-indent=false 
%}
```
