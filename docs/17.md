...
<a target="__blank" href="https://leetcode.com/problems/letter-combinations-of-a-phone-number/"><input class="verify-button" type="button" value="Verify on LeetCode"/></a>
