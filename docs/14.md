...
<a target="__blank" href="https://leetcode.com/problems/longest-common-prefix/"><input class="verify-button" type="button" value="Verify on LeetCode"/></a>

```python
{% 
    include "../python/_14.py" 
    preserve-includer-indent=false 
%}
```
