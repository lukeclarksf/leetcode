...
<a target="__blank" href="https://leetcode.com/problems/longest-palindromic-substring/"><input class="verify-button" type="button" value="Verify on LeetCode"/></a>

```python
{% 
    include "../python/_5.py" 
    preserve-includer-indent=false 
%}
```
